...
export function FormField({ field, label, description, className, ...inputProps }: FormFieldProps) {
	...
	return (
		<div className="space-y-1.5">
			...
			<Input
				...
				className={cn(hasError && "border-destructive ring-destructive", className)}
				{...inputProps}
			/>
			{hasError && (
