...
export async function createJournalEntry(body: JournalRequest): Promise<number> {
...
export async function updateJournalEntry(id: number, body: JournalRequest): Promise<void> {
