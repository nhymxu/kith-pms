...
import { labelSchema, labelListSchema, type Label, type LabelList, type LabelRequest } from "../schemas/label"
...
export async function updateLabel(id: number, body: LabelRequest): Promise<void> {
