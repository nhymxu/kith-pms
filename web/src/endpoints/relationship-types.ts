...
export async function createRelationshipType(body: RelationshipTypeRequest): Promise<RelationshipType> {
	const res = await apiFetch<Envelope<unknown>>("/v1/relationship-types", {
		method: "POST",
...
export async function updateRelationshipType(id: number, body: RelationshipTypeRequest): Promise<void> {
