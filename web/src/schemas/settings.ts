...
// GET/PUT /v1/settings return the persisted UserSettings plus these read-only,
// server-config-derived fields — they aren't user preferences, so they're kept
// out of userSettingsSchema (the PUT request body shape).
